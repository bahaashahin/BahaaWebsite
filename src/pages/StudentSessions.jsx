...
//         {sessions.map((s) => {
//           const isCompleted = completedMap?.[s.id]?.completed === true;

//           return (
//             <div
//               key={s.id}
//               className={`relative backdrop-blur-xl border rounded-2xl p-5 flex flex-col gap-3 shadow-lg transition duration-300 hover:scale-[1.03] w-full
//               ${
//                 isCompleted
...
//               <h2 className="text-xl font-bold break-words">{s.title}</h2>
...
//                 className="mt-3 bg-blue-600 hover:bg-blue-700 transition text-white py-2 rounded-xl font-medium w-full"
//               >
//                 Enter Session
//               </button>
        ...
        {sessions.map((s) => {
          ...
          return (
            ...
            >
              ...
              {/* GLOW */}
              {isCompleted && (
                <div className="absolute -top-8 -right-8 w-28 h-28 bg-green-500/20 blur-3xl rounded-full pointer-events-none" />
              )}
            </div>
          );
        })}
